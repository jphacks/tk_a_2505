        ...
        VStack(spacing: 24) {
            ...
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    TextField(
                        String(localized: "group.create.name_placeholder", bundle: .main),
                        text: $groupViewModel.createGroupName
                    )
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    TextField(
                        String(localized: "group.create.description_placeholder", bundle: .main),
                        text: $groupViewModel.createGroupDescription, axis: .vertical
                    )
                    .textFieldStyle(RoundedBorderTextFieldStyle())
                    .lineLimit(3 ... 6)
            ...
            VStack(spacing: 12) {
                Button(action: {
                    Task {
                        ...
                        // Switch to My Groups tab after successful creation
                    ...
                    HStack {
                        ...
                        Text(
                            groupViewModel.isCreatingGroup
                                ? String(localized: "group.create.creating", bundle: .main)
                                : String(localized: "group.create.button", bundle: .main)
                        )
                        .fontWeight(.semibold)
                    }
                ...
                VStack(spacing: 8) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        CreateGroupInfoRow(
                            icon: "key", text: String(localized: "group.create.after_invite_code", bundle: .main)
                        )
                        CreateGroupInfoRow(
                            icon: "crown", text: String(localized: "group.create.after_owner", bundle: .main)
                        )
                        CreateGroupInfoRow(
                            icon: "person.badge.plus",
                            text: String(localized: "group.create.after_max_members", bundle: .main)
                        )
                    }
                    .padding(.horizontal)
                }
...
#Preview {
    CreateGroupView(groupViewModel: GroupViewModel(), selectedTab: .constant(.createGroup))
}
